...
static const yytype_uint8 yyprhs[] =
{
      ...
      20,    22,    24,    27,    28,    31,    33,    36,    38,    41,
      44,    47,    49,    52,    53,    54,    64,    65,    71,    72,
      73,    83,    85,    92
};
...
{
      16,     0,    -1,    -1,    17,    18,    -1,    -1,    11,    -1,
      24,    -1,    25,    11,    -1,    30,    11,    -1,     1,    -1,
      11,    -1,    12,    -1,    19,    11,    -1,    -1,    20,    11,
      -1,    10,    -1,    21,    10,    -1,    21,    -1,    22,    19,
      -1,    34,    19,    -1,    28,    19,    -1,    23,    -1,    23,
      24,    -1,    -1,    -1,     5,    10,    26,    20,    13,    27,
      20,    24,    14,    -1,    -1,    13,    29,    20,    24,    14,
      -1,    -1,    -1,     6,    31,    21,    20,    13,    32,    20,
      24,    14,    -1,     3,    -1,    33,    24,     8,    20,    24,
       9,    -1,    33,    24,     8,    20,    24,     7,    20,    24,
       9,    -1
};
...
{
       0,    56,    56,    56,    62,    63,    64,    65,    66,    67,
      76,    77,    78,    81,    82,    87,    91,    97,   104,   105,
     106,   110,   114,   129,   132,   128,   155,   154,   167,   170,
     166,   183,   187,   192
};
#endif
...
{
  "$end", "error", "$undefined", "\"if\"", "\"while\"", "\"function\"",
  "\"menuentry\"", "\"else\"", "\"then\"", "\"fi\"",
  "GRUB_PARSER_TOKEN_ARG", "'\\n'", "';'", "'{'", "'}'", "$accept",
  "script_init", "$@1", "script", "delimiter", "newlines", "arguments",
  "grubcmd", "command", "commands", "function", "$@2", "$@3",
  "commandblock", "$@4", "menuentry", "$@5", "$@6", "if_statement", "if", 0
};
#endif
...
{
       2,     0,     0,     1,     9,    31,     0,    28,    15,     5,
      26,     3,    17,     0,    21,     6,     0,     0,     0,     0,
       0,    23,     0,    13,    16,    10,    11,    18,    22,     7,
      20,     8,     0,    19,    13,    13,     0,    12,    13,     0,
       0,    14,     0,     0,    24,    29,    27,     0,    13,    13,
      13,    32,     0,     0,     0,     0,     0,     0,    25,    30,
      33
};
...
{
      -1,     1,     2,    11,    27,    36,    12,    13,    14,    15,
      16,    34,    48,    17,    23,    18,    22,    49,    19,    20
};
...
{
     -33,    14,    20,   -33,   -33,   -33,     9,   -33,   -33,   -33,
     -33,   -33,    18,    33,    24,   -33,    13,    33,    21,    24,
      33,   -33,    25,   -33,   -33,   -33,   -33,    31,   -33,   -33,
      31,   -33,    28,    31,   -33,    18,    -2,   -33,   -33,    -1,
       2,   -33,    32,    -2,   -33,   -33,   -33,    34,   -33,   -33,
     -33,   -33,    -2,    -2,    -2,    35,    36,    38,   -33,   -33,
     -33
};
...
{
      28,     5,    39,    40,    30,    32,    43,    33,     8,    41,
      41,    10,    44,    41,     3,    45,    52,    53,    54,    21,
      -4,     4,    42,     5,    29,     6,     7,     5,    24,    47,
       8,     9,    31,    10,     8,     8,    38,    10,    55,    56,
      57,    50,    37,    51,    25,    26,    46,    60,    35,    58,
      59
};

static const yytype_uint8 yycheck[] =
{
      14,     3,    34,    35,    17,    19,    38,    20,    10,    11,
      11,    13,    13,    11,     0,    13,    48,    49,    50,    10,
       0,     1,    36,     3,    11,     5,     6,     3,    10,    43,
      10,    11,    11,    13,    10,    10,     8,    13,    52,    53,
      54,     7,    11,     9,    11,    12,    14,     9,    22,    14,
      14
};
...
{
       0,    16,    17,     0,     1,     3,     5,     6,    10,    11,
      13,    18,    21,    22,    23,    24,    25,    28,    30,    33,
      34,    10,    31,    29,    10,    11,    12,    19,    24,    11,
      19,    11,    24,    19,    26,    21,    20,    11,     8,    20,
      20,    11,    24,    20,    13,    13,    14,    24,    27,    32,
       7,     9,    20,    20,    20,    24,    24,    24,    14,    14,
       9
};
...
#line 115 "./script/parser.y"
    {
		    ...
		    cmd = (struct grub_script_cmdblock *) (yyvsp[(2) - (2)].cmd);
		    (yyval.cmd) = grub_script_add_cmd (state, cmd, (yyvsp[(1) - (2)].cmd));
		  ;}
    break;
...
#line 138 "./script/parser.y"
    {
		    ...
		    state->func_mem = grub_script_mem_record_stop (state,
								   state->func_mem);
		    script = grub_script_create ((yyvsp[(8) - (9)].cmd), state->func_mem);
		    if (script)
		      grub_script_function_create ((yyvsp[(2) - (9)].arg), script);
...
#line 173 "./script/parser.y"
    {
		    ...
		    grub_script_lexer_deref (state->lexerstate);
		    (yyval.cmd) = grub_script_create_cmdmenu (state, (yyvsp[(3) - (9)].arglist), menu_entry, 0);
		  ;}
    break;
